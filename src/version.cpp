...
// for both BitcoinPlusd and BitcoinPlus-qt, to make it harder for attackers to
// target servers or GUI users specifically.
const std::string CLIENT_NAME("BitcoinPlus");

// Client version number
#define CLIENT_VERSION_SUFFIX   "-Hash"
...
#        define BUILD_DATE "March 25, 2014"
#    else
