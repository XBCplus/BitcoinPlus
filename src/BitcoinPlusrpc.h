...
#ifndef _BitcoinPlusRPC_H_
#define _BitcoinPlusRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // BitcoinPlus is not connected
...
/**
 * BitcoinPlus RPC command dispatcher.
 */
class CRPCTable
{
private:
