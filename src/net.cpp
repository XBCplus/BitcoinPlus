...
// Copyright (c) 2014e MIT/X11 software license, see the accompanying
...
*/
    ...
    GenerateBitcoinPluss(GetBoolArg("-gen", false), pwalletMain);
}
...
bool StopNode()
{
    ...
    if (vnThreadsRunning[THREAD_MINER] > 0) printf("ThreadBitcoinPlusMiner still running\n");
