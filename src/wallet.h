...
#ifndef BitcoinPlus_WALLET_H
#define BitcoinPlus_WALLET_H
...
enum WalletFeature
{
    FEATURE_BASE = 9000, // the earliest version new wallets supports (only useful for getinfo's clientversion output)
